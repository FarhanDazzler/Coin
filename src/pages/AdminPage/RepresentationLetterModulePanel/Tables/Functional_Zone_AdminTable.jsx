  ...
  return (
    <>
            ...
            <div className="mdm-table-button">
              <div className="table-heading" style={{ justifyContent: 'space-between' }}>
                <div>
                  ...
                  <span style={{ paddingLeft: '16px' }}>Functional Zone IC Persona Role Table</span>
                </div>
                <div>
                  <Button
                    variant="outlined"
      ...
      <CustomModal
        ...
        title={
          modalType === 'add'
            ? 'Add individual for Functional Zone IC Persona'
            : 'Modify individual for Functional Zone IC Persona'
        }
        bodyClassName="p-0"
      >
        <Functional_Zone_Model
...
export default Functional_Zone_AdminTable;
