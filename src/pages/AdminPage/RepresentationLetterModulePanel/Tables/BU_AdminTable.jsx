...
const BU_AdminTable = () => {
  ...
  const getAll_GIC_Role =
    ...
    getAll_Roles_data?.data[1][0]?.BU_Admins?.length &&
  ...
  return (
    <>
              ...
              <div className="table-heading" style={{ justifyContent: 'space-between' }}>
                <div>
                  ...
                  <span style={{ paddingLeft: '16px' }}>
                    Business Unit Global Persona Role Table
                  </span>
                </div>
                <div>
                  <Button
      ...
      <CustomModal
        ...
        title={
          modalType === 'add'
            ? 'Add individual for Business Unit Global Persona'
            : 'Modify individual for Business Unit Global Persona'
        }
        bodyClassName="p-0"
      >
        <BU_Model
