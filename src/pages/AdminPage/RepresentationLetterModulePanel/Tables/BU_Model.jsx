...
const BU_Model = ({ setShowModal, ediatbleData, setEditTableData, modalType }) => {
  ...
  const handleSave = (values) => {
    if (modalType === 'edit') {
      ...
      console.log(payload, 'BU edit payload');
      ...
      console.log(payload, 'BU add payload');
