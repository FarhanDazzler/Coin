...
import {
  ...
  clearLatestBUZoneDraftResponse,
...
const Section1 = ({ questions, scopeData }) => {
  ...
  const DraftResponseState = useSelector(getLatestBUZoneDraftResponseSelector);
  const addOrUpdateDraftResponseState = useSelector(addOrUpdateBUZoneDraftResponseSelector);
  ...
  useEffect(() => {
    return () => {
      dispatch(clearLatestBUZoneDraftResponse());
  ...
  const handleSaveDraft = () => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        dispatch(addOrUpdateBUZoneDraftResponse(payload));
