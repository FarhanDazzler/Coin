  ...
  const reportComponent = (
    <PowerBIEmbed
      embedConfig={{
        ...
        id: process.env.REACT_APP_REP_LETTER_BU_POWERBI_REPORT_ID, //report Id
        embedUrl: process.env.REACT_APP_REP_LETTER_BU_POWERBI_EMBED_URL,
