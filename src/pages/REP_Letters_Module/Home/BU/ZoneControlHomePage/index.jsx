...
import ZoneControlHomePage from './ZoneControlHomePage';
import BUZone_ZoneControlHomePage from './BUZone_ZoneControlHomePage';

const ZoneControlHomePageContainer = () => {
  ...
  return (
    <>
      ...
      {activeTab === 'BU' ? <ZoneControlHomePage /> : <BUZone_ZoneControlHomePage />}
    </>
  );
};

export default ZoneControlHomePageContainer;
