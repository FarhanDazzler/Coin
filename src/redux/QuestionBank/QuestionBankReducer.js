...
const initialState = {
  section1EditQuestionTranslation: {
    data: {},
    loading: false,
    error: null,
    success: null,
  ...
  section1GetQuestionTranslation: {
    data: {},
    loading: false,
    error: null,
    success: null,
...
export default function section1QuestionDataReducer(state = getInitialState(), action) {
  switch (action.type) {
    case ATTEMPT_GET_SECTION1_QUESTIONS_TRANSLATION:
      return {
        ...state,
        section1GetQuestionTranslation: {
          data: {},
    ...
    case GET_SECTION1_QUESTIONS_TRANSLATION_SUCCESS:
      return {
        ...state,
        section1GetQuestionTranslation: {
          data: action.data ? action.data[0] : {},
          loading: false,
          error: '',
          success: '',
        },
      };
    case GET_SECTION1_QUESTIONS_TRANSLATION_FAILED:
      return {
        ...state,
        section1GetQuestionTranslation: {
          data: {},
    ...
    case ATTEMPT_EDIT_SECTION1_QUESTIONS_TRANSLATION:
      return {
        ...state,
        section1EditQuestionTranslation: {
          data: {},
